<%@ page import="com.api.web.practice.rental.model.Rent" %>
          ...
          <input type="hidden" name="id"  value="${Rentedit.id}">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="phone" value="${Rentedit.phone}" placeholder="Phone-Number">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="area" value="${Rentedit.area}" placeholder="Area of house">
            </div>
