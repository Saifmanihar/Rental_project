  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="SellingHouse">House-for-sell</a>
  ...
  <div class="container-fluid d-flex justify-content-between mt-4">
     ...
     <div class="pos-f-t "> 
      ...
      <nav class="navbar navbar-dark bg-dark">
          <button class="navbar-toggler navbar-toggler-left" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
          </button>
      </nav>
  </div>
     ...
     <!-- Record Data Start-->
     <a class="btn btn-primary"href="Form" role="button">New Submission</a>
     <!-- Record Data End-->
  </div>
